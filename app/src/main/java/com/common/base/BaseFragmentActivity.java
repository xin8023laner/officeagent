...
public abstract class BaseFragmentActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // viewUtils=new  ViewUtils(initViewsAndValues(savedInstanceState),this);
    ...
    public void intent(Class desClass, IntentExtra value) {
		if (null != value) {
			startActivity(new Intent(this, desClass).putExtra(IntentExtra.intent,
					value));
		} else {
	...
	public void intentForResult(Class desClass, IntentExtra value,
		...
		if (null != value) {
			startActivityForResult(
					new Intent(this, desClass).putExtra(IntentExtra.intent, value),
					requestCode);
		} else {
        ...
        getApp().getHttpUtils().send(HttpRequest.HttpMethod.POST, url, params,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(final ResponseInfo<String> responseInfo) {
                        MsMessage msMessage = JsonParser.getJsonParser(BaseFragmentActivity.this).parseJsonToMsMessage(responseInfo.result);
