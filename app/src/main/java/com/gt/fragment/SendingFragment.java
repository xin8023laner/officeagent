...
//				showLoadingDialog(Constant.queryReceiveTaskList);
				doRequest(Constant.querySendingList);
			}
...
//			maps.put("agentUserCode", "005");
			...
			requestServer(Constant.RECEIVETASK_SERVER,
					Constant.querySendingList, AppUtils.createParams(
							ApiCode.querySendingList.code, paramsValues));
			break;
...
//					doEmptyCheck();
//				}
				sendAdapter = new SendAdapter(getActivity(), agentReceiveTasks,Constant.LIST_SEND_PAISONG);
